...
console.log(`The diet of velociraptors was ${raptor.diet}.`);

// How long was a stegosaurus?
console.log(`Stegosaurus was ${steg['length']} long.`);

// What time period did tyrannosaurus live in?
console.log(`Tyrannosaurus lived during the ${tRex.period} period.`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`The tyrannosaurus said ${tRex.roar = "RAWERSRARARWERSARARARRRR!"}`);
...
zooAnimals.filter(function(currentValue){
  if (currentValue.population < 5){
    lowPopulationAnimals.push(currentValue);
  }
})
